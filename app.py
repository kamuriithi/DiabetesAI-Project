...
# ══════════════════════════════════════════════════════════════════════════════
if page == "🏠  Overview":
    st.markdown("<h2 style='text-align: center; color: red;font-size: 42px;'>🩺 DiabetesAI Project — Clinical Decision Support Dashboard</h2>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; color: black; font-size: 30px;'><em>Predictive modelling with Explainable AI for diabetes risk assessment</em></p>", unsafe_allow_html=True)
    st.markdown("---")
